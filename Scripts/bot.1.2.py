...
#'Collect' button 1 after match coordinates: X:  866 Y:  936 RGB: (105, 200,  16)
#'Collect' button 2 after match coordinates: X:  727 Y:  818 RGB: (106, 201,  17)
...
def verifyIfGameIsOver():
    ...
    while gameIsOver == False:
        ...
        #Verifiyng if the 'Collect 2' message has appeared
        if pyautogui.pixel(727,818) [0] == 106:
            if pyautogui.pixel(727,818) [1] == 201:
                if pyautogui.pixel(727,818) [2] == 17:
                    print()
                    print('"Collect" button 2 has appeared')
                    pressEsc()
                    gameIsOver = True
        else:
            print('"Collect" button 2 NOT found')
